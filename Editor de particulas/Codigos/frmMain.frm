...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ListBox List2 
         Height          =   3960
         ItemData        =   "frmMain.frx":00D6
         Left            =   45
         List            =   "frmMain.frx":00D8
         TabIndex        =   95
         Top             =   240
         Width           =   2295
      End
   ...
   Begin VB.Frame frameGrhs 
      ...
      Begin VB.Label Label21 
         ...
         Caption         =   "Indice Grafico Particulas"
         Height          =   195
         Left            =   2160
         TabIndex        =   92
         Top             =   240
...
Dim RetVal
CurStreamFile = App.Path & "\INIT\particulas.ini"
...
'Write particle data to particulas.ini
...
If lstGrhs.ListCount = 1 Then
lstGrhs.Clear
Call cargarlstgrh
End If
Else
lstGrhs.Clear
lstGrhs.AddItem (Text1.Text)
End If
End Sub
...
StreamData(frmMain.List2.ListIndex + 1).AlphaBlend = 0
''chkAlphaBlend.value
End Sub
