...
Public Type tHechizo
    ...
    MetaObj As Integer 'asusta no se usaba, lo use para saber el objeto que se necesita para transfomarse
    Extrahit As Byte
    Extradef As Byte
    body As Integer
    Head As Integer
...
Public Type User
    ...
    'Add Marius Antifrag
    Matados(1 To MAX_BUFFER_KILLEDS) As Integer
    Matados_timer(1 To MAX_BUFFER_KILLEDS) As Long
    '\Add
...
Public Type MapBlock
    Blocked As Byte 'Deberia ser un Boolean solo usa 2 valores 0 o 1 :S
