...
'***************************************************
        ...
        Select Case Comando
            ...
            Case "/PROPONER"
                ...
                Else
                    ...
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /CASAMIENTO  NICKNAME.", , , , True, True)
                End If
            ...
            Case "/DIVORCIO"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /DIVORCIO  NICKNAME.", , , , True, True)
                End If
            ...
            Case "/DESC"
                If Len(ArgumentosRaw) > 100 Then
                    Call ShowConsoleMsg("La descripcion es muy larga.")
                Else
            ...
            Case "/PARTICIPAR"
                ...
                If notNullArguments Then
                    Call WriteParticipar(ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan paramtetros. Utilice /PARTICIPAR EVENTO.")
                End If
            ...
            Case "/FADD"
                If notNullArguments Then
                    Call WriteFriends(1, ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parametros. Utilice /FADD nick")
                End If
            
            Case "/FDEL"
                If notNullArguments Then
                    Call WriteFriends(2, ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parametros. Utilice /FDEL nick")
                End If
            
            Case "/FLIST"
                If notNullArguments Then
                    If UCase$(ArgumentosRaw) = "ONLINE" Then
                        Call WriteFriends(3, ArgumentosRaw)
                    ElseIf UCase$(ArgumentosRaw) = "ALL" Then
                        Call WriteFriends(4, ArgumentosRaw)
                    Else
                        Call ShowConsoleMsg("Faltan parametros. Utilice /FLIST [Online|All]")
                    End If
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parametros. Utilice /FLIST [Online|All]")
            ...
            Case "/FMSG"
                If notNullArguments Then
                    Call WriteFriends(5, ArgumentosRaw)
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parametros. Utilice /FMSG Texo")
                End If
            ...
            Case "/FUNDARCLAN"
                If UserLVL >= 40 Then
                    WriteGuildFundate
                Else
                    Call ShowConsoleMsg("Para fundar un clan tenés que ser nivel 40 o mayor , tener 100 skills en liderazgo y poseer 1 Gema Lunar.")
                End If
            ...
            Case "/FMMG"
                If notNullArguments Then
                    Call WriteChatFaccion(ArgumentosRaw)
                Else
                    Call ShowConsoleMsg("Escriba un mensaje.")
                End If
            ...
            #If ClienteGM = 1 Then
                ...
                Case "/CREARTORNEO"
                    ...
                    If notNullArguments Then
                        Call WriteCrearTorneo(ArgumentosRaw)
                    Else
                        'Avisar que falta el parametro
                        Call ShowConsoleMsg("Escriba el numero de rondas.")
                    End If
                    
                    
                Case "/CANCELTORNEO"
                    Call WriteCancelTorneo
                ...
                Case "/ONLINEARMY"
                    Call WriteOnlineArmada
                    
                Case "/ONLINECAOS"
                    Call WriteOnlineCaos
                
                Case "/ONLINEMILI"
                    Call WriteOnlineMilicia
                ...
                'Add Marius Reviviendo viejos comandos de fenix
                Case "/GO"
                ...
                Case "//"
                    If notNullArguments Then
                        Call WriteSlashSlash(ArgumentosRaw)
                    End If
                ...
                Case "/PEJOTAS"
                    If notNullArguments Then
                        Call WritePejotas(ArgumentosRaw)
                    Else
                        'Avisar que falta el parametro
                        Call ShowConsoleMsg("Faltan parámetros. Utilice /pejotas NICKNAME.")
                    End If
                ...
                Case "/CITEM"
                    Dim o As Integer
                    For o = 1 To UBound(objs())
                        Call frmSpawnItem.List1.AddItem(objs(o).name)
                    Next o
                    frmSpawnItem.Show , frmMain
                ...
                Case "/CI"
                    If notNullArguments And CantidadArgumentos > 1 Then
                        If ValidNumber(ArgumentosAll(0), eNumber_Types.ent_Integer) And ValidNumber(ArgumentosAll(1), eNumber_Types.ent_Long) Then
                    ...
                    ElseIf notNullArguments Then
                        'Avisar que falta el parametro
                        If CantidadArgumentos = 1 Then Call WriteCreateItem(val(ArgumentosAll(0)), 1)
                    End If
                ...
                Case "/NOMILI"
                    If notNullArguments Then
                        Call WriteMiliciaKick(ArgumentosRaw)
                    Else
                        'Avisar que falta el parametro
                        Call ShowConsoleMsg("Faltan parámetros. Utilice /nomili NICKNAME.")
                    End If
                    ...
                    If notNullArguments Then
                        If ArgumentosAll(0) <> "" Then
                            ...
                            For i = 1 To UBound(objs)
                                If InStr(1, Tilde(objs(i).name), Tilde(ArgumentosRaw)) Then
                                    Call AddToChat(i & " " & objs(i).name & ".")
                                    N = N + 1
                                End If
                            Next
                            
                            If N = 0 Then
                                Call AddToChat("No hubo resultados de la busqueda: " & ArgumentosRaw)
                            Else
                                Call AddToChat("Hubo " & N & " resultados de la busqueda: " & ArgumentosRaw)
                            End If
                        End If
                    End If
            ...
            Case Else
                AddToChat "Comando no reconocido."
    ...
    ElseIf Left$(Comando, 1) = "-" Then
        ...
        End If
        ' Gritar
        Call WriteTalk(mid$(RawCommand, 2), 2)
    ElseIf Left$(Comando, 1) = ";" Then
        Call WriteTalk(mid$(RawCommand, 2), 3)
    Else
        ' Hablar
        Call WriteTalk(RawCommand, 1)
    End If
End Sub
...
'
'***************************************************
    Call AddtoRichTextBox(frmMain.RecChat, Message, red, green, blue, bold, italic)
End Sub
...
Function Tilde(ByRef f As String) As String
    Tilde = LCase$(Replace$(Replace$(Replace$(Replace$(Replace$(f, "í", "i"), "è", "e"), "ó", "o"), "á", "a"), "ú", "u"))
End Function
