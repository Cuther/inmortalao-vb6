    ...
    Select Case KeyCode
        ...
        Case KeyCodeConstants.vbKeyReturn
            If (Not frmComerciar.Visible) And (Not frmComerciarUsu.Visible) And _
              ...
              (Not frmEstadisticas.Visible) And (Not frmCantidad.Visible) And (Not frmCorreo.Visible) Then
        ...
        If MouseShift = 0 Then
            If MouseBoton <> vbRightButton Then
                ...
                Else
                    ...
                    'SAQUE EL INTERVALO POR TIMEMR DE HECHIZOS PORQUE
                    'ME PARECIA UNA REVERENDA PORONGA.
                ...
                End If
            Else
                If Not frmForo.Visible And Not frmComerciar.Visible And Not frmBancoObj.Visible And Not frmCorreo.Visible Then
...
On Error Resume Next  'el .SetFocus causaba errores al salir y volver a entrar
    ...
    ElseIf (Not frmComerciar.Visible) And (Not frmComerciarUsu.Visible) And _
      (Not frmBancoObj.Visible) And _
      (Not frmMSG.Visible) And (Not frmForo.Visible) And _
      (Not frmEstadisticas.Visible) And (Not frmCantidad.Visible) And (picInv.Visible) And (Not frmCorreo.Visible) Then
        picInv.SetFocus
    End If
End Sub
...
Private Sub Socket1_Disconnect()
    ...
    Do While i < Forms.count - 1
        ...
        If Forms(i).name <> Me.name And Forms(i).name <> frmConnect.name And Forms(i).name <> frmCrearPersonaje.name And Forms(i).name <> frmMensaje.name Then
            Unload Forms(i)
        End If
    Loop
