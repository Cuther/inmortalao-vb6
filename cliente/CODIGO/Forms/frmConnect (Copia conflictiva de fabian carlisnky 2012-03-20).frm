...
Private Sub Form_Load()
    ...
    If perm = True Then
    WebBrowser1.Navigate ("http://inmortalao.com.ar/?noticias=true")
    serverList = mInet.OpenURL("http://inmortalao.com.ar/getserver.php")
    End If
...
Private Sub cmdNewAccount_Click()
    ...
    ShellExecute Me.hwnd, "open", "ttp://inmortalao.com.ar/login.php?action=register", "", "", 1
End Sub
...
perm = False
    ...
    frmMensaje.msg.Caption = "Complete los campos de Usuario y Contraseña para poder ingresar."
    frmMensaje.Show
