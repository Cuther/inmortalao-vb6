...
Begin VB.Form frmPanelGm 
   ...
   Begin VB.CommandButton TabStrip 
      Caption         =   "Admin"
      Height          =   255
      Index           =   5
      Left            =   3360
...
Private Sub CmdIntermund_Click()
    '/TELEP
    Dim tStr As String
    Dim Nick As String
    ...
    If LenB(Nick) <> 0 Then
        Call ParseUserCommand("/TELEP " & Nick & " 49 50 50") 'We use the Parser to control the command format
    End If
End Sub
...
Private Sub cmdIntermundia_Click()
    '/TELEP NICK 49 50 50
    Dim tStr As String
    Dim Nick As String
